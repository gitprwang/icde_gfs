...
from src.models.ddgcrn import DDGCRN
from src.engines.ddgcrn_engine import DDGCRN_Engine
...
def get_config():
    args = get_public_config()
    # args = argparse.ArgumentParser(description='arguments')
    #model
    args.add_argument('--embed_dim', default=12, type=int)
    args.add_argument('--rnn_unit', default=64, type=int)
    args.add_argument('--num_layer', default=1, type=int)
    args.add_argument('--cheb_k', default=2, type=int)
    args.add_argument('--use_day', default=True, type=eval)
    args.add_argument('--use_week', default=True, type=eval)
    #train
    args.add_argument('--lrate', default=3e-3, type=float)
    args.add_argument('--wdecay', default=0, type=float)
    args.add_argument('--clip_grad_value', type=float, default=0)
...
def main():
    ...
    # print(dataloader['train_loader'].data[0])
    # exit()
    model = DDGCRN(args)
    ...
    engine = DDGCRN_Engine(device=device,
                          model=model,
